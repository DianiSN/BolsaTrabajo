...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-example-diana-finalproject.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-example-diana-finalproject)

This repository contains the source code for the [FinalProject](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.example.diana.finalproject).

Please see the [issues](https://github.com.example.diana.finalproject/com-example-diana-finalproject/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about FinalProject? Ask away on the [com-example-diana-finalproject discussion forum](https://groups.google.com/forum/#!forum/com-example-diana-finalproject).

<a href="https://play.google.com/store/apps/details?id=com.example.diana.finalproject" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.example.diana.finalproject__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.example.diana.finalproject__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.example.diana.finalproject.R__) will now be renamed
...
signed with a different key.  Manually uninstall FinalProject from your device and
...
FinalProject is a result of a template project I've developed over the years as well as
...
FinalProject is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.example.diana.finalproject/com-example-diana-finalproject/contributors) on
...
[pull requests](https://github.com.example.diana.finalproject/com-example-diana-finalproject/pulls).
