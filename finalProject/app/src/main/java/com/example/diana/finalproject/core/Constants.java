...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.example.diana.finalproject";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "FinalProject";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.example.diana.finalproject.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.example.diana.finalproject.";
